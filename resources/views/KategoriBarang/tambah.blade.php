...
@section('title', 'Penambahan Kategori')

@section('content_header')
    <h1 class="m-0 text-dark text-center">TAMBAH KATEGORI</h1>
@stop

@section('content')
<form method="POST" action="{{ route('insert.kategori') }}" enctype="multipart/form-data">
    @method('POST')
    @csrf
        ...
        <a class="btn btn-primary" href="{{route ('admin.kategori')}}"><i
            ></i>Kembali</a>
